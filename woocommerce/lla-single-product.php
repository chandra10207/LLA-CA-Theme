...
<div class="fusion-clearfix"></div></div></div><div class="fusion-clearfix"></div></div></div>
		...
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<?php wc_get_template_part( 'llacontent', 'single-product' ); ?>
...
<div class="fusion-fullwidth fullwidth-box fusion-fullwidth-2  fusion-parallax-none nonhundred-percent-fullwidth order_mobile_row2" style="border-color:#eae9e9;border-bottom-width: 0px;border-top-width: 0px;border-bottom-style: solid;border-top-style: solid;padding-bottom:20px;padding-top:50px;padding-left:30px;padding-right:30px;padding-left:30px !important;padding-right:30px !important;background-color:#f4f2ef;"><style type="text/css" scoped="scoped">.fusion-fullwidth-2 {
                        ...
                        }</style><div class="fusion-row"><div class="fusion-one-third fusion-layout-column fusion-spacing-yes" style="margin-top:0px;margin-bottom:20px;"><div class="fusion-column-wrapper"><p><img class="aligncenter size-full wp-image-224" src="https://www.livelifealarms.ca/wp-content/uploads/2019/08/lady-with-live-life-personal-medical-alarm-pendant-4GX.jpg" alt="lady with live life personal medical alarm pendant 4GX" width="239" height="277"></p>
<h2 data-fontsize="21" data-lineheight="31"><span style="font-weight: 900; color: #4a4c9a;">No</span> monthly monitoring fees ever.</h2>
<p>In an emergency your 4GX <strong>Live<span style="color: #e40030;">Life</span> Mobile Alert</strong> contacts the people who love you and know you the most – your family and friends. Ongoing costs are just $75 each year from Year 2 (pays for unlimited emergency calls and texts).</p>
<p><strong>What’s included with your 4GX mobile alarm:</strong></p>
...
<li>Calls and sends text messages to up to six emergency contacts when the SOS/Heart button is clicked or pressed. Calls until someone on the contact list answers the call. It will stop calling the other numbers if the wearer ends the call sequence.</li>
<li>Using Bluetooth, wifi or GPS all help text messages contain a link to Google Maps displaying the location of the wearer on a map.</li>
...
<ul class="template_ul">
<li>Location feature: Want to know exactly where the person wearing the pendant is? Just send a simple text message to the pendant and it will send back their location on Google Maps.</li>
<li>Uses the best 4GX signal from either Rogers, Bell, Telus, Tbaytel, MTS or Sasktel (depending on location) which gives the widest coverage in Canada of 99.5% of all populated areas.</li>
	<li>Fall detection: If a fall is detected the medical alert pendant&nbsp;sends text messages with your location to up to 6&nbsp;contacts.&nbsp;A <a class="fusion-modal-text-link" data-toggle="modal" data-target=".fusion-modal.fall_alarm_sound" href="#"><strong>voice from the alarm</strong></a> will guide you through the emergency call sequence and allow you to cancel if a false alarm.</li>
...
<li>No contracts or monthly monitoring fees. 30 day money back <strong><a href="/refund-policy/">guarantee</a>&nbsp;</strong>, 12 month full warranty &amp; limited lifetime warranty.</li>
</ul>
</div>
<div style="clear: both;"></div>
...
<p style="margin-top: 30px;"><strong>30 Day Moneyback Guarantee</strong></p>
<p>The <strong>Live<span style="color: #e40030;">Life</span></strong> Mobile Alarm comes with a 30 day money-back guarantee. Simply return the alarm unit in it’s original packaging within 30 days of purchase for a full refund.</p>
...
<li>Uses GPS, Bluetooth and wifi tracking to locate pendant with link to location in Google Maps to approximately 2 metres.</li>
...
<li>Waterproof rating of IP7.</li>
<li>Battery type: Lithium-ion, 850mAh capacity, 3.7V.</li>
<li>Recharge from low battery warning to full in 30 minutes.</li>
