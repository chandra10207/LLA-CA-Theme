...
<div class="fusion-clearfix"></div></div></div><div class="fusion-clearfix"></div></div></div>
		...
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<?php wc_get_template_part( 'llacontent', '3g' ); ?>
...
<p>In an emergency your <strong>Live<span style="color: #e40030;">Life</span> Mobile Alert</strong> contacts the people who love you and know you the most – your family & friends. Ongoing costs are just $45 each year from Year 2 (pays for unlimited calls & texts).</p>
...
<ul class="template_ul">
<li>Includes unlimited emergency calls and texts for the first year. Second year just $45.</li>
