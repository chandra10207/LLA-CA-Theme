...
<div itemscope itemtype="<?php echo woocommerce_get_product_schema(); ?>" id="product-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="lla_mobile_images" style="width: 42%; float: left;">
		<div class="image_removeonDesktop">
			...
			<img src="https://www.livelifealarms.ca/wp-content/uploads/2022/01/mobile-medical-emergency-seniors-watch-slider-canada.jpg" alt="mobile-medical-emergency-seniors-watch-slider-canada" title="mobile-medical-emergency-seniors-watch-slider-canada">
		</div>
		
		<div id="slider" class="fusion-flexslider slider_removeonMobile">
			<div class="order_mobile_row1"><?php masterslider(10); ?></div>
		</div>
