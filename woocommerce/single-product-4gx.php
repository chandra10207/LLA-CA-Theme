...
<h3 style="float: left;"><span style="font-weight: 900; color: #4a4c9a;">Mobile Alert with Fall Detect, Hands Free Voice & GPS.</span>&nbsp;Enjoy freedom. <span style="font-weight: 900;">Order:</span> <a id="number_link" style="font-size: 17px; font-family: bitter; color: #4a4c9a;" href="tel:1-877-801-7172"><strong><span class="number">1-877-801-7172</span></strong></a></h3>
<p><img class="alignright size-full wp-image-199" src="https://livelifealarms.ca/wp-content/uploads/2016/10/alarm-pendants-free-delivery-icon.png" alt="alarm-pendants-free-delivery-icon" width="211" height="30" srcset="https://livelifealarms.ca/wp-content/uploads/2016/10/alarm-pendants-free-delivery-icon-120x17.png 120w, https://livelifealarms.ca/wp-content/uploads/2016/10/alarm-pendants-free-delivery-icon-200x28.png 200w, https://livelifealarms.ca/wp-content/uploads/2016/10/alarm-pendants-free-delivery-icon.png 211w" sizes="(max-width: 211px) 100vw, 211px"><br>
...
<div class="fusion-clearfix"></div></div></div><div class="fusion-clearfix"></div></div></div>
		...
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<?php wc_get_template_part( 'llacontent', '4gx' ); ?>
...
<p>In an emergency your <strong>Live<span style="color: #e40030;">Life</span> Mobile Alert</strong> contacts the people who love you and know you the most – your family & friends. Ongoing costs are just $75 each year from Year 2 (pays for unlimited calls & texts).</p>
...
<li>Calls and sends text messages to up to 5&nbsp;emergency contacts when the SOS&nbsp;button is pressed for 3&nbsp;seconds. Calls until someone on the contact list answers the call. It will stop calling the other numbers if the wearer or a responder ends the call sequence.</li>
...
<li>Fall detection: If a fall is detected the medical alert pendant&nbsp;sends text messages with your location to up to 5&nbsp;contacts.&nbsp;The alarm will beep &amp; vibrate for 20 seconds. If not cancelled in this time the fall alert text is sent.</li>
...
<li>No contracts or monthly monitoring fees. 14 day money back <strong><a href="/refund-policy/">guarantee</a>&nbsp;</strong>, 12 month full warranty &amp; limited lifetime warranty.</li>
</ul>
</div>
<div style="clear: both;"></div>
...
<ul class="template_ul">
<li>Operates using a Prepaid Micro SIM card. Total cost as low as $25 per year. This covers emergency calls.</li>
...
<li>In an emergency calls and texts up to 5 contacts. Can include 911.</li>
